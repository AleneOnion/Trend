...
temp1<-temp %>%
  ...
  ungroup() %>% 
  spread(index,Result.Value)
temp1<-temp1[rowSums(is.na(temp1))==0,]
temp1<-temp1 %>% select(LAKE_ID,combined,year) %>% distinct()
temp<-merge(temp1,temp,by=c('LAKE_ID','combined','year'),all.x = TRUE)

#Now average monthly values
temp<-temp %>% 
  group_by(LAKE_ID,combined,year,month) %>% 
  summarize(Result.Value=mean(Result.Value)) %>% 
  ungroup() 
...
slopesh2<-slopesh %>% 
  ...
  mutate(LAKE_ID=as.factor(LAKE_ID),
         LAKE_ID=fct_reorder(LAKE_ID,Secchi)) %>% 
...
print(ggplot(correlations2,aes(param,LAKE_ID))+
        ...
        scale_fill_gradient2(low = muted("darkred"), 
                       ...
                       high = muted("midnightblue"), 
                       midpoint = 0)+
        geom_hline(yintercept='0602PET0078',size=2)+
        geom_hline(yintercept='0602CRO0073',size=2)+
        scale_color_manual(values=c(NA,'black'))+
        guides(color=FALSE)+
        theme(panel.grid.major.x=element_blank(), #no gridlines
          panel.grid.minor.x=element_blank(), 
...
print(ggplot(correlations2,aes(param,LAKE_ID))+
        ...
        scale_fill_gradient2(low = muted("darkred"), 
                       ...
                       high = muted("midnightblue"), 
                       midpoint = 0)+
        geom_hline(yintercept='0602BRA0154',size=2)+
        geom_hline(yintercept='0601BEA0174',size=2)+
        scale_color_manual(values=c(NA,'black'))+
        guides(color=FALSE)+
        theme(panel.grid.major.x=element_blank(), #no gridlines
          panel.grid.minor.x=element_blank(), 
...
print(ggplot(correlations2,aes(param,LAKE_ID))+
        ...
        scale_fill_gradient2(low = muted("darkred"), 
                       ...
                       high = muted("midnightblue"), 
                       midpoint = 0)+
        geom_hline(yintercept='0602EAT0163',size=2)+
...
print(ggplot(correlations2,aes(param,LAKE_ID))+
        ...
        scale_fill_gradient2(low = muted("darkred"), 
                       ...
                       high = muted("midnightblue"), 
                       midpoint = 0)+
        geom_hline(yintercept='0201CUB0115',size=2)+
        geom_hline(yintercept='0703PAN0094',size=2)+
        scale_color_manual(values=c(NA,'black'))+
        guides(color=FALSE)+
        theme(panel.grid.major.x=element_blank(), #no gridlines
          panel.grid.minor.x=element_blank(), 
...
print(ggplot(correlations2,aes(param,LAKE_ID))+
        ...
        scale_fill_gradient2(low = muted("darkred"), 
                       ...
                       high = muted("midnightblue"), 
                       midpoint = 0)+
        geom_hline(yintercept='0906BLA0001',size=2)+
        geom_hline(yintercept='0303LOR0009',size=2)+
        scale_color_manual(values=c(NA,'black'))+
        guides(color=FALSE)+
        theme(panel.grid.major.x=element_blank(), #no gridlines
          panel.grid.minor.x=element_blank(), 
